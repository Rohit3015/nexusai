export default async function handler(req, res) {
  ...
  const { history } = req.body; // Extracting history from request body
  ...
  try {
    // Calling the Gemini API using the server-side environment variable
    ...
    // Returning the reply to the frontend
